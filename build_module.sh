...
chmod 0755 action.sh customize.sh service.sh uninstall.sh scripts/*.sh META-INF/com/google/android/update-binary bin/sqlite3 bin/keycheck 2>/dev/null || true
